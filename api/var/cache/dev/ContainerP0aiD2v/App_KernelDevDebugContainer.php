...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once \dirname(__DIR__, 4).'/src/EventSubscriber/AgreeToTermsSubscriber.php';
            ...
            include_once \dirname(__DIR__, 4).'/src/Service/CommentHelper.php';
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('V9HkxMXzW5', 0, ($this->targetDir.''.'/pools/app'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wFLl7+EJSp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5uiC7uwyiD', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\BigFootSightingRepository' => ['privates', 'App\\Repository\\BigFootSightingRepository', 'getBigFootSightingRepositoryService', true],
            ...
            'App\\Repository\\BigFootSightingRepository' => '?',
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.request', [0 => #[\Closure(name: 'App\\EventSubscriber\\AgreeToTermsSubscriber')] function () {
            return ($this->privates['App\\EventSubscriber\\AgreeToTermsSubscriber'] ?? $this->getAgreeToTermsSubscriberService());
        }, 1 => 'onRequestEvent'], 0);
        $instance->addListener('console.command', [0 => #[\Closure(name: 'App\\EventSubscriber\\ApmCommand')] function () {
            return ($this->privates['App\\EventSubscriber\\ApmCommand'] ??= new \App\EventSubscriber\ApmCommand());
        }, 1 => 'onConsoleCommand'], 0);
        $instance->addListener('console.terminate', [0 => #[\Closure(name: 'App\\EventSubscriber\\ApmCommand')] function () {
            return ($this->privates['App\\EventSubscriber\\ApmCommand'] ??= new \App\EventSubscriber\ApmCommand());
    ...
    /**
     * Gets the private 'App\EventSubscriber\AgreeToTermsSubscriber' shared autowired service.
     *
     * @return \App\EventSubscriber\AgreeToTermsSubscriber
     */
    protected function getAgreeToTermsSubscriberService()
    {
        $a = ($this->privates['form.factory'] ?? $this->getForm_FactoryService());

        if (isset($this->privates['App\\EventSubscriber\\AgreeToTermsSubscriber'])) {
            return $this->privates['App\\EventSubscriber\\AgreeToTermsSubscriber'];
        }
        ...
        return $this->privates['App\\EventSubscriber\\AgreeToTermsSubscriber'] = new \App\EventSubscriber\AgreeToTermsSubscriber(new \Symfony\Bundle\SecurityBundle\Security(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
        ...
        ])]), $a, $b, ($this->privates['webpack_encore.entrypoint_lookup[_default]'] ?? $this->getWebpackEncore_EntrypointLookupDefaultService()));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('-j7IpGFQds', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rPnjcYMHU+', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9euxxLWQk2', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('R9KCYpJH1T', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getApiPlatform_Mercure_Listener_Response_AddLinkHeaderService()
    {
        ...
        if (isset($this->privates['api_platform.mercure.listener.response.add_link_header'])) {
            return $this->privates['api_platform.mercure.listener.response.add_link_header'];
        }

        return $this->privates['api_platform.mercure.listener.response.add_link_header'] = new \ApiPlatform\Symfony\EventListener\AddLinkHeaderListener(new \Symfony\Component\Mercure\Discovery(($this->privates['Symfony\\Component\\Mercure\\HubRegistry'] ?? $this->getHubRegistryService())), $a);
    }
    ...
    protected function getAssets_PackagesService()
    {
        ...
        return $this->privates['assets.packages'] = new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('/api', new \Symfony\Component\Asset\VersionStrategy\JsonManifestVersionStrategy((\dirname(__DIR__, 4).'/public/build/manifest.json'), ($this->privates['.debug.http_client'] ?? $this->get_Debug_HttpClientService()), false), new \Symfony\Component\Asset\Context\RequestStackContext(($this->services['request_stack'] ??= new \Symfony\Component\HttpFoundation\RequestStack()), $a->getBaseUrl(), $a->isSecure())), new RewindableGenerator(function () {
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hRzdyW2D+L', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fTLPVIO3H-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('r-SoPFsROF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tWWC8AgG27', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vWxdUvXgOF', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.webpack_encore'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MU6U5c3GpG', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getForm_RegistryService()
    {
        return $this->privates['form.registry'] = new \Symfony\Component\Form\FormRegistry([0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Form\\AgreeToUpdatedTermsFormType' => ['privates', 'App\\Form\\AgreeToUpdatedTermsFormType', 'getAgreeToUpdatedTermsFormTypeService', true],
            ...
            'App\\Form\\AgreeToUpdatedTermsFormType' => '?',
            ...
            yield 4 => ($this->privates['form.type_extension.form.data_collector'] ?? $this->load('getForm_TypeExtension_Form_DataCollectorService'));
            yield 5 => ($this->privates['form.type_extension.form.password_hasher'] ?? $this->load('getForm_TypeExtension_Form_PasswordHasherService'));
        }, 6), 'Symfony\\Component\\Form\\Extension\\Core\\Type\\TextType' => new RewindableGenerator(function () {
            yield 0 => ($this->privates['form.type_extension.form.html_sanitizer'] ?? $this->load('getForm_TypeExtension_Form_HtmlSanitizerService'));
    ...
    protected function getSecurity_AuthorizationCheckerService()
    {
        ...
        return $this->privates['security.authorization_checker'] = new \Symfony\Component\Security\Core\Authorization\AuthorizationChecker(($this->services['security.token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), $a, false, false);
    }
    ...
    {
        return $this->privates['security.context_listener.0'] = new \Symfony\Component\Security\Http\Firewall\ContextListener(($this->services['security.token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage()), new RewindableGenerator(function () {
    ...
    protected function getSerializerService()
    {
        ...
        $o = ($this->privates['api_platform.api.identifiers_extractor'] ?? $this->getApiPlatform_Api_IdentifiersExtractorService());
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($n, $k, $g, $a, new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($n), NULL);

        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), 1 => $i, 2 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($j, [], $k), 3 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $k), 4 => new \ApiPlatform\GraphQl\Serializer\Exception\ValidationExceptionNormalizer($this->parameters['api_platform.exception_to_status']), 5 => new \ApiPlatform\GraphQl\Serializer\Exception\HttpExceptionNormalizer(), 6 => new \ApiPlatform\GraphQl\Serializer\Exception\RuntimeExceptionNormalizer(), 7 => new \ApiPlatform\GraphQl\Serializer\Exception\ErrorNormalizer(), 8 => $i, 9 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $l, $m, $j, $k), 10 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $d, $j), 11 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($j, true), 12 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 13 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 14 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 15 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $l, $d, $m, $e, $g, $k, $n, [], $f), 16 => new \ApiPlatform\GraphQl\Serializer\ItemNormalizer($c, $l, $d, $o, $m, $g, $k, $n, NULL, $b, $f), 17 => new \ApiPlatform\Serializer\ItemNormalizer($c, $l, $d, $m, $g, $k, $n, NULL, $b, $f), 18 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 19 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $k), 20 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 24 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 25 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 26 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($e, $m, $d, NULL), 'page', 'pagination', $b, $g), $b, $m, ($this->privates['api_platform.filter_locator'] ??= new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []))), 27 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 28 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($p, $d, $e), 29 => new \ApiPlatform\GraphQl\Serializer\ObjectNormalizer($p, $d, $o), 30 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $h, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld', NULL), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getTwigService()
    {
        ...
        $g = ($this->services['security.token_storage'] ??= new \Symfony\Component\Security\Core\Authentication\Token\Storage\TokenStorage());
        ...
        $i = ($this->privates['Symfony\\Component\\Mercure\\HubRegistry'] ?? $this->getHubRegistryService());
        ...
        $instance->addExtension(new \App\Twig\AppExtension(new \App\Service\CommentHelper()));
        ...
        $instance->addExtension(new \Symfony\Component\Mercure\Twig\MercureExtension($i, new \Symfony\Component\Mercure\Authorization($i, NULL), $f));
        ...
        $instance->addGlobal('site_name', $this->getEnv('resolve:SITE_NAME'));
    ...
    private function getDynamicParameter(string $name)
    {
        $value = match ($name) {
            ...
            'kernel.trusted_proxies' => $this->getEnv('TRUSTED_PROXIES'),
            ...
            'api_platform.title' => $this->getEnv('string:default:default_title:API_SITE_NAME'),
            'mercure.hubs' => [
